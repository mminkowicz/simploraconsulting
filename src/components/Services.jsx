...
const services = [
  {
    ...
    description: 'Ongoing support and updates for platforms like Salesforce, HubSpot, Monday, and more.',
    icon: FaTools,
    gradient: 'from-blue-500 to-cyan-500'
  },
  {
    title: 'Customization',
    description: 'Tailored fields, workflows, and automation built for how your team actually operates.',
    icon: FaCogs,
    gradient: 'from-purple-500 to-indigo-500'
  },
  {
    title: 'Integrations',
    description: 'Connect your forms, email, calendars, CRMs, and tools into one seamless system.',
    icon: FaPlug,
    gradient: 'from-pink-500 to-red-400'
  },
  {
    title: 'Implementation',
    description: 'We handle setup, migration, onboarding, and launch — done fast and done right.',
    icon: FaRocket,
    gradient: 'from-green-500 to-emerald-400'
  },
  {
    title: 'Automation',
    description: 'Reminders, sequences, drip flows, and triggers to keep everything moving automatically.',
    icon: FaSyncAlt,
    gradient: 'from-yellow-400 to-orange-400'
  },
  {
    title: 'Data Services',
    description: 'Cleanup, deduplication, segmentation, imports, exports, and list logic done cleanly.',
    icon: FaDatabase,
  ...
  return (
    <section className="py-28 bg-white" id="services">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          {services.map((service, index) => (
            <motion.div
              ...
              className="h-full"
            >
              <div className="group h-full rounded-xl bg-gradient-to-br from-white to-gray-50 shadow hover:shadow-xl transition-all duration-500 hover:-translate-y-2 p-8">
        ...
        >
          <p className="text-sm font-semibold text-gray-500 tracking-wide uppercase mb-6">
